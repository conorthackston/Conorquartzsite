...
<p style="font-size: 1.8rem; color: #86868b; max-width: 700px; margin: 0 auto; line-height: 1.5; font-weight: 400; letter-spacing: -0.01em;">
  Bridging the gap between complex digital tools and meaningful learning outcomes.
</p>
</div>

<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 2.5rem; padding: 2rem 0; max-width: 1100px; margin: 0 auto;">

  <!-- Card 1: Leadership (Compass Mountain) -->
  <a href="portfolio/Instructional Technology Portfolio" style="text-decoration: none; color: inherit; background: #f0f7ff; border: 1px solid #dce9f5; border-radius: 32px; overflow: hidden; display: flex; flex-direction: column; transition: transform 0.3s ease; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
    <div style="width: 100%;">
      <img src="/attachments/leadership-final.png" style="width: 100%; height: 350px; object-fit: cover; display: block;">
  ...
  <a href="about/About Me" style="text-decoration: none; color: inherit; background: #f0f7ff; border: 1px solid #dce9f5; border-radius: 32px; overflow: hidden; display: flex; flex-direction: column; transition: transform 0.3s ease; box-shadow: 0 10px 30px rgba(0,0,0,0.03);">
    <div style="width: 100%;">
      <img src="/attachments/vision-final.png" style="width: 100%; height: 350px; object-fit: cover; display: block;">
      <div style="padding: 2.5rem;">
        <h2 style="font-size: 2.4rem; font-weight: 700; margin: 0; color: #1d1d1f; letter-spacing: -0.02em;">Insights & Vision</h2>
        <p style="font-size: 1.2rem; color: #434345; margin-top: 0.8rem; font-weight: 450;">Philosophy, Blog & Reflections →</p>
      </div>
    </div>
  </a>
